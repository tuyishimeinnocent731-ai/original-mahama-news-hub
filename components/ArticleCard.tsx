...
const ArticleCard: React.FC<ArticleCardProps> = ({ article, onArticleClick, layoutMode = 'normal' }) => {
  if (layoutMode === 'compact') {
    return (
        <div onClick={() => onArticleClick(article)} className="bg-white dark:bg-gray-800 rounded-lg shadow-md overflow-hidden cursor-pointer hover:shadow-xl transition-shadow duration-300 flex flex-col h-full group">
